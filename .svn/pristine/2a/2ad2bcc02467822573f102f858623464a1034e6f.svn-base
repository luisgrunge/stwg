...
<?php
	...
	$site_owners_email = 'stwgltda@gmail.com'; // Replace this with your own email address
	$site_owners_name = 'ServerEast - SHARED ON THEMELOCK.COM'; // replace with your name
